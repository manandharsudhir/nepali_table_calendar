...
import '../shared/nepali_date_utils.dart' show NepaliTextFormatter;

/// Class containing styling for `TableCalendar`'s days of week panel.
class NepaliDaysOfWeekStyle {
  ...
  /// ```
  final NepaliTextFormatter? dowTextFormatter;
