...
import '../shared/nepali_date_utils.dart'
    show NepaliDayBuilder, NepaliFocusedDayBuilder;
...
typedef SingleMarkerBuilder<T> = Widget? Function(
    BuildContext context, NepaliDateTime day, T event);
...
typedef MarkerBuilder<T> = Widget? Function(
    BuildContext context, NepaliDateTime day, List<T> events);
...
class NepaliCalendarBuilders<T> {
  ...
  final NepaliFocusedDayBuilder? outsideBuilder;
