...
import 'widgets/nepali_calendar_core.dart';

class NepaliTableCalendarBase extends StatefulWidget {
  ...
  @override
  _NepaliTableCalendarBaseState createState() =>
      _NepaliTableCalendarBaseState();
}

class _NepaliTableCalendarBaseState extends State<NepaliTableCalendarBase> {
  ...
  @override
  void didUpdateWidget(NepaliTableCalendarBase oldWidget) {
  ...
  bool get _canScrollHorizontally =>
      widget.availableGestures == NepaliAvailableGestures.all ||
      widget.availableGestures == NepaliAvailableGestures.horizontalSwipe;

  bool get _canScrollVertically =>
      widget.availableGestures == NepaliAvailableGestures.all ||
      widget.availableGestures == NepaliAvailableGestures.verticalSwipe;
  ...
  int _calculateFocusedPage(NepaliCalendarFormat format,
      NepaliDateTime startDay, NepaliDateTime focusedDay) {
    switch (format) {
