...
import 'package:nepali_table_calendar/src/nepali_table_calendar_base.dart';

import 'customization/nepali_calendar_builders.dart';
import 'customization/calendar_style.dart';
import 'customization/nepali_days_of_week_style.dart';
import 'customization/nepali_header_style.dart';
import 'shared/nepali_date_utils.dart';
import 'widgets/nepali_calendar_header.dart';
import 'widgets/nepali_cell_content.dart';
...
class NepaliTableCalendar<T> extends StatefulWidget {
  ...
  final NepaliAvailableGestures availableGestures;
  ...
  final NepaliDaysOfWeekStyle daysOfWeekStyle;
  ...
  final NepaliCalendarBuilders<T> calendarBuilders;
  ...
  final void Function(NepaliCalendarFormat format)? onFormatChanged;
  ...
  NepaliTableCalendar({
    ...
    this.availableCalendarFormats = const {
      NepaliCalendarFormat.month: 'Month',
      NepaliCalendarFormat.twoWeeks: '2 weeks',
      NepaliCalendarFormat.week: 'Week',
    },
    ...
    this.availableGestures = NepaliAvailableGestures.all,
    this.simpleSwipeConfig = const SimpleSwipeConfig(
      verticalThreshold: 25.0,
      swipeDetectionBehavior: SwipeDetectionBehavior.continuousDistinct,
    ),
    this.headerStyle = const NepaliHeaderStyle(),
    this.daysOfWeekStyle = const NepaliDaysOfWeekStyle(),
    this.calendarStyle = const CalendarStyle(),
    this.calendarBuilders = const NepaliCalendarBuilders(),
    ...
    this.onCalendarCreated,
        ...
        assert(availableCalendarFormats.length <=
            NepaliCalendarFormat.values.length),
  ...
  @override
  _NepaliTableCalendarState<T> createState() => _NepaliTableCalendarState<T>();
}

class _NepaliTableCalendarState<T> extends State<NepaliTableCalendar<T>> {
  ...
  @override
  void didUpdateWidget(NepaliTableCalendar<T> oldWidget) {
  ...
  bool get _shouldBlockOutsideDays =>
      ...
      widget.calendarFormat == NepaliCalendarFormat.month;
  ...
  void _updateFocusOnTap(NepaliDateTime day) {
    ...
    if (widget.calendarFormat == NepaliCalendarFormat.month) {
  ...
  Widget _buildCell(NepaliDateTime day, NepaliDateTime focusedDay) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        Widget content = NepaliCellContent(
